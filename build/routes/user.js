...
router.get("/user/search", fetchUser_1.fetchUser, user_1.searchUser);
...
router.put("/user/tagline", fetchUser_1.fetchUser, [
    (0, express_validator_1.body)("tagline")
        .trim()
        .isLength({ min: 20, max: 350 })
        .withMessage("Name should be at least 20 and at most 350 characters long..."),
